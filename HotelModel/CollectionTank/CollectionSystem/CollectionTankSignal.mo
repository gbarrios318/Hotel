...
equation
  ...
  connect(product.y, product1.u1) annotation (Line(
      ...
      color={0,0,127},
      smooth=Smooth.None));
  connect(integrator.u, product2.y) annotation (Line(
      points={{-22,40},{-30,40},{-30,60},{-39,60}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(product2.u2, RaiWatIn) annotation (Line(
      points={{-62,54},{-80,54},{-80,0},{-120,0}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(product2.u1, Intom.y) annotation (Line(
      points={{-62,66},{-66,66},{-66,80},{-69,80}},
      color={0,0,127},
      smooth=Smooth.None));
