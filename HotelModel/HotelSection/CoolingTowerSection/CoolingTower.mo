within HotelModel.HotelSection.CoolingTowerSection;
model CoolingTower "Single module of the cooling tower"
...
equation
  ...
  connect(val.y, product.u2) annotation (Line(
      ...
      smooth=Smooth.None,
      pattern=LinePattern.Dash));
  connect(yorkCalc.TLvg, conPI.u_m) annotation (Line(
      points={{21,-6},{40,-6},{40,62},{-70,62},{-70,68}},
      color={0,0,127},
      smooth=Smooth.None,
      pattern=LinePattern.Dash));
